...
These two matricies give the point estimate of the difference in RMSE (gam - knn) as showing that there is weak evidence that knn predicts has a lower RMSE (difference = 0.001279; p = 0.04888). Similarly we have weak evidence that the knn has a higher R-squared (difference = -0.002; p = 0.05332). 
...
The bias correction term, $\hat{z}_0$ is derived from the number of $\hat{\theta}^*$ values that are less than the original $\hat{\theta}$
